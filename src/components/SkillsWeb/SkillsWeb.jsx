	              ...
	              {this.state.display
			      	?<GridItem className='animate fadeInDown' xs={12} sm={12} md={12} >
	                	<GridContainer className={classes.hiddenMain}>
			               <GridItem sm={12} md={4} className={classes.alternateBox} style={{background: "#3da4ab"}}>
	                		<h3>Websites</h3>
	                		<h4>for presentation</h4>
			               </GridItem>
			               <GridItem className={'animate fadeInRight one ' + classes.artBox} sm={12} md={4} style={{background: `url(${image1}) no-repeat center center`}}>
	                		<Button color="info" target="_blank">Work in progress</Button> 
			               </GridItem>
			               <GridItem className={'animate fadeInRight two ' + classes.artBox} sm={12} md={4} style={{background: `url(${image2}) no-repeat center center`}}>
	                		   <Button color="info" href="https://andragh83.github.io/giftr/" target="_blank">Click to see!</Button>
			               </GridItem>
			               
			               <GridItem sm={12} md={4} className={classes.alternateBox} style={{background: "#63b6bb"}}>
	                		<h3>Apps</h3>
	                		<h4>simple</h4>
			               </GridItem>
			               <GridItem className={'animate fadeInRight three ' + classes.artBox} sm={12} md={4} style={{background: `url(${image3}) no-repeat center center`}}>
	                			<Button color="info" href="https://andragh83.github.io/Tictactoe/" target="_blank">Click to play!</Button>
			               </GridItem>
			               <GridItem className={'animate fadeInRight four ' + classes.artBox} sm={12} md={4} style={{background: `url(${image4}) no-repeat center center`}}>
	                		  <Button color="info" href="https://andragh83.github.io/color-game-practice-webdevbootcamp/" target="_blank">Click to play!</Button>
			               </GridItem>
			            </GridContainer>
	              	</GridItem> 
			      	:null
